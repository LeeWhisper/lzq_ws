...
public:
    ...
    void line_fitting(vector<double> x, vector<double> y, double &k, double &b);                                                                                              // y=kx+b//平面直线
    void polynomial2D_fitting(vector<double> x, vector<double> y, double &a, double &b, double &c);                                                                           // y=a*x^2+b*x+c;//平面曲线
    void polynomial3D_fitting(vector<double> x, vector<double> y, vector<double> z, double &a, double &b, double &c);                                                         // z=a*(x^2+y^2)+b*sqrt(x^2+y^2)+c//空间曲线
