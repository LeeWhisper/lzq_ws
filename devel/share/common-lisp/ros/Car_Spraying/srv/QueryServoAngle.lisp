...
(cl:in-package Car_Spraying-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <QueryServoAngle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryServoAngle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Car_Spraying-srv:<QueryServoAngle-request> is deprecated: use Car_Spraying-srv:QueryServoAngle-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <QueryServoAngle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Car_Spraying-srv:id-val is deprecated.  Use Car_Spraying-srv:id instead.")
  (id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<QueryServoAngle-request>)))
  ...
  "Car_Spraying/QueryServoAngleRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QueryServoAngle-request)))
  "Returns string type for a service object of type 'QueryServoAngle-request"
  "Car_Spraying/QueryServoAngleRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <QueryServoAngle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryServoAngle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Car_Spraying-srv:<QueryServoAngle-response> is deprecated: use Car_Spraying-srv:QueryServoAngle-response instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <QueryServoAngle-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Car_Spraying-srv:angle-val is deprecated.  Use Car_Spraying-srv:angle instead.")
  (angle m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<QueryServoAngle-response>)))
  ...
  "Car_Spraying/QueryServoAngleResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QueryServoAngle-response)))
  "Returns string type for a service object of type 'QueryServoAngle-response"
  "Car_Spraying/QueryServoAngleResponse")
