...
(cl:defmethod cl:initialize-instance :after ((m <SetServoAngle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetServoAngle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Car_Spraying-msg:<SetServoAngle> is deprecated: use Car_Spraying-msg:SetServoAngle instead.")))
...
(cl:defmethod angle-val ((m <SetServoAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Car_Spraying-msg:angle-val is deprecated.  Use Car_Spraying-msg:angle instead.")
  (angle m))
