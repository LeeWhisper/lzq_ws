...
(cl:defmethod cl:initialize-instance :after ((m <SetServoDamping>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetServoDamping)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Car_Spraying-msg:<SetServoDamping> is deprecated: use Car_Spraying-msg:SetServoDamping instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <SetServoDamping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Car_Spraying-msg:id-val is deprecated.  Use Car_Spraying-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'power-val :lambda-list '(m))
(cl:defmethod power-val ((m <SetServoDamping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Car_Spraying-msg:power-val is deprecated.  Use Car_Spraying-msg:power instead.")
  (power m))
